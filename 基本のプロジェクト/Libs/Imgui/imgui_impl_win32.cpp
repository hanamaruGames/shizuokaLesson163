...
// 画面の拡縮処理のためウインドウの初期サイズを追加                   // -- 2020.8.7
...
// 
//   画面の拡縮処理に対応できるように
//   ウインドウの初期サイズを設定する     int WidthIn, int HeightIn   // -- 2020.8.7
// 
bool    ImGui_ImplWin32_Init(void* hwnd, int WidthIn, int HeightIn)
//bool    ImGui_ImplWin32_Init(void* hwnd)    // 元の内容
{
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CHAR:
	{
		...
		{
			// 全角文字は日本語入力処理                                               // -- 2020.8.7
			// （入力されてきたUTF16をUTF8に変換する）
